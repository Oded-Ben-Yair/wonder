...
function matchNurses(query) {
  ...
  // Filter by city - handle variations like "Tel Aviv" vs "Tel Aviv-Yafo", "Haifa" vs "Hefa"
  if (city) {
    ...
    filtered = filtered.filter(n => {
      ...
      if (nCityLower === mappedCity) return true;

      // Then check for partial matches
      return nCityLower.includes(mappedCity) || mappedCity.includes(nCityLower);
    });
